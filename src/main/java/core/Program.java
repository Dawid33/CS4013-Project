...
public class Program extends Application {
    ...
    public static final String BOOKINGS_PATH = "bookings.csv";
    public static final String ARCHIVE_PATH = "archive.csv";
    public static final String USERS_PATH = "users.csv";
